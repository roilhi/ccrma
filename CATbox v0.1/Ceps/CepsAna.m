function [C,S,E,win_pos] =  CepsAna (a,lift,win,overlap,nfft)
%[C,S,E,win_pos] =  CepsAna (a,lift,win,overlap,nfft)
%this function calculate the Cepstral envelope and pitch for input vector a 
%a - sample vector
...
% (c) Shlomo Dubnov sdubnov@ucsd.edi
